...
var MarshalFloat32sTests = []marshalTests{
	{
		line:     line(),
		input:    map[string]json.Marshaler{"float32 slice": pfmt.Float32s(0.123456789, 0.987654321)},
	...
	{
		line:     line(),
		input:    map[string]json.Marshaler{"slice without float32": pfmt.Float32s()},
		want:     "",
		wantText: "",
		wantJSON: `{
	...
	},
	{
		...
		input: func() map[string]json.Marshaler {
			...
			return map[string]json.Marshaler{"slice of any float32": pfmt.Anys(f, f2)}
		}(),
		want:     "0.12345679 0.9876543",
		wantText: "0.12345679 0.9876543",
		wantJSON: `{
	...
	},
	{
		...
		input: func() map[string]json.Marshaler {
			var f, f2 float32 = 0.123456789, 0.987654321
			return map[string]json.Marshaler{"slice of float32 reflects": pfmt.Reflects(f, f2)}
		}(),
		want:     "0.12345679 0.9876543",
		wantText: "0.12345679 0.9876543",
		wantJSON: `{
